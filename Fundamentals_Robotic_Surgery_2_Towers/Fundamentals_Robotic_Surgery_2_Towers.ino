...
int performTask1(){
  ...
  while(true){
    ...
    if(RING_1_BC_VAL == 1 || RING_2_BC_VAL == 1){
  ...
  digitalWrite(RING_1_LED,LOW);
  Tower_Time_Stamp = millis() - Tower_Time_Stamp_Start;
  PrintToFile(Tower_Time_Stamp,2,0,RING_SC_VAL,Total_Tower_Touch,0);
  ...
  while(true){
    ...
    while(true){
      ...
      Tower_Time_Stamp = millis() - Tower_Time_Stamp_Start;
      PrintToFile(Tower_Time_Stamp,2,0,RING_SC_VAL,Total_Tower_Touch,Tower_Touch_Time);
